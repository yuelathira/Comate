    ...
    <div class="container">
        <div class="navigasi">
            ...
            <nav>
                ...
                <div class="nav">
                    <span><img src="image/html.png"><a href="/html" style="color: blue;">HTML</a></span>
        ...
        <div class="main">
            <div class="headmain">
                <div class="head-container">
                    <span class="input">
                        ...
                        ?>
                            <a href="/input">
                                <input type="submit" name="input" value="Input Materi" style="background-color:mediumblue; color: white">
                            </a>
                        <?php
                        }
                        ?>
            ...
            <div class="content">
                <h1 style="margin-left: 5px;">COURSE HTML</h1>
                <table>
                    <?php $no = 1;
